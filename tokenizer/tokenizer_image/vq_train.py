...
def main(args):
    ...
    if args.vq_ckpt:
        ...
        print("Succesfully load the VQ model...")
        if args.ema:
...
if __name__ == "__main__":
    result_folder_default = "/hai/scratch/wepeng/results/LlamaGen"
    parser = argparse.ArgumentParser()
    parser.add_argument("--data-path", type=str, default="/hai/scratch/wepeng/MRI_3Set")
    parser.add_argument("--data-face-path", type=str, help="face datasets to improve vq model",default=None)
    parser.add_argument("--cloud-save-path", type=str, help='please specify a cloud disk path, if not, local path', default=result_folder_default)
    ...
    parser.add_argument("--results-dir", type=str, default=result_folder_default)
    parser.add_argument("--dataset", type=str, default='mri')
    parser.add_argument("--image-size", type=int, choices=[256, 128], default=128)
    parser.add_argument("--crop", type=int, default=(96,96,96))##only for training
    parser.add_argument("--rotate", type=int, default=true)# #only for traiing

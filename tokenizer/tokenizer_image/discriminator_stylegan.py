...
class Discriminator(nn.Module):
    def __init__(self, input_nc=1, ndf=64, n_layers=3, channel_multiplier=1, image_size=256):
        super().__init__()
        channels = {
            4: 512,
            8: 512,
        ...
        blocks = [nn.Conv3d(input_nc, in_channel, 3, padding=1), leaky_relu()]
        ...
        self.final_conv = nn.Sequential(
            nn.Conv3d(in_channel, channels[4], 3, padding=1),
            leaky_relu(),
        )
